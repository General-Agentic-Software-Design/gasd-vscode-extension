...
connection.onCompletion((textDocumentPosition): CompletionItem[] => {
     ...
     */
    function kw(label: string, detail: string, newText?: string): CompletionItem {
    ...
    function ann(label: string, detail: string): CompletionItem {
        return {
            label,
    ...
    function typ(label: string, detail: string): CompletionItem {
        return {
            label,
    ...
    function snippet(label: string, detail: string, snippetText: string): CompletionItem {
        return {
            label,
...
function fixKeywordsOnLine(line: string, lineIndex: number): import('vscode-languageserver/node.js').TextEdit[] {
    const edits: import('vscode-languageserver/node.js').TextEdit[] = [];
    let match;
...
connection.onCodeAction((params) => {
    ...
    const actions: import('vscode-languageserver/node.js').CodeAction[] = [];
